		...
		<tr>
			...
			<td>
				<select name="kanunadi" id="">
					<?php 
						$kanungetir = mysqli_query($baglan, "select * from kanunlar");
						while ($kanungelsin = mysqli_fetch_array($kanungetir)) {
							extract($kanungelsin);
							echo "<option value='$kanunadi'>$kanunadi</option>";
						}
					 ?>					
				</select>
			</td>
			...
			<td>
				<select name="kanunno" id="">
					<?php 
						...
						while ($kanungelsin = mysqli_fetch_array($kanungetir)) {
							extract($kanungelsin);
							echo "<option value='$kanunno'>$kanunno</option>";
						}
					 ?>					
				</select>
			</td>

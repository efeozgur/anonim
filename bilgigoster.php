...
<?php include('menu.php'); ?>
	...
	<?php 
		...
		while ($bilgi = mysqli_fetch_array($bilgisorgula)) {
			extract($bilgi);
			echo "<h4><a target='_blank' href='tekanungoster.php?ilgili=$bilgibaslik'>$bilgibaslik</a>. madde hakkında bilgi</h4><p style='font-size:10px;'><a href='bilgiedit.php?id=$id'>[Düzenle]</a></p><hr>"; 
